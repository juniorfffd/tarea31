package com.facci.ingreso_de_votantes_fffd;
...
import com.facci.ingreso_de_votantes_fffd.DBhelper;

public class MainActivityFFFD extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_fffd);
    ...
    public void InsetarBtn (View v) {
        ...
        if (Insertadatos) {
            Toast.makeText(MainActivityFFFD.this, "Datos Ingresados", Toast.LENGTH_SHORT).show();
        }else{Toast.makeText(MainActivityFFFD.this,"Datos no Ingresados ocurrio un error",Toast.LENGTH_SHORT).show();}
    }
    ...
    public void Modificar (View v) {
        ...
        if(ActualizandoDatos)
            ...
            Toast.makeText(MainActivityFFFD.this,"Lo sentimos ocurrió un error",Toast.LENGTH_SHORT).show();
    ...
    public void Eliminar (View v) {
        ...
        if(registrosEliminados > 0 ){
            Toast.makeText(MainActivityFFFD.this,"Registro(s) Eliminado(s)",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MainActivityFFFD.this,"ERROR: Registro no eliminado",Toast.LENGTH_SHORT).show();
        }
    }
